...
def generate_roboflow_ANTS_mix_reduced_slope():
  path = input("specify a path to save the mix (default ./result/mixes/roboflow_ANTS_reduced_slope): ") or "./results/mixes/roboflow_ANTS_reduced_slope"
